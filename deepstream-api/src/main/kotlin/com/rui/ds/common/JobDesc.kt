...
class DataSourceConfig(
    ...
    val connectString: String = String.format(connectURLFormat.get(type, DATABASE_SUBTYPE_DEFAULT)!!, host, port, dbName)
    ...
    companion object {
        ...
        private const val DATABASE_SUBTYPE_DEFAULT = 0
        private const val DATABASE_SUBTYPE_CLUSTER = 1
