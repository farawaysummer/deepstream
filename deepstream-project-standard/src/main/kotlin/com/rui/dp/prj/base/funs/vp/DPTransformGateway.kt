...
class DPTransformGateway private constructor(
    ...
    companion object {
        fun newGateway(dsConf: DataSourceConfig): DPTransformGateway {
            DatabaseSources.registryDataSource(dsConf)

            return DPTransformGateway(
                DatabaseSources.getDataSource(dsConf.name)!!
            )
        }
    }
}