...
class DatetimeTypeSupport : TypeSupport {
    override fun convert(fieldName: String, sourceType: TypeInformation<*>): String {
        val convertWord = when (sourceType) {
            ...
            Types.LOCAL_DATE -> "TO_TIMESTAMP(DATE_FORMAT($fieldName, \"${DeepStreamTypes.DATE_TIME_FORMAT}\"), \"${DeepStreamTypes.DATE_TIME_FORMAT}\")"
            Types.LOCAL_TIME -> "TO_TIMESTAMP(DATE_FORMAT($fieldName, \"${DeepStreamTypes.DATE_TIME_FORMAT}\"), \"${DeepStreamTypes.DATE_TIME_FORMAT}\")"
